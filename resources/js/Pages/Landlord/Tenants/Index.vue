...
<template>
  <MainNavLayout>
        ...
        <div>
          <h1 class="text-3xl font-black text-gray-900 flex items-center gap-3">
            <div class="p-2 bg-purple-100 rounded-xl">
              <Domain class="text-purple-600" :size="28" />
            </div>
            Gestion des Tenants
          </h1>
          ...
          <div class="bg-white rounded-lg border border-purple-200 shadow-sm flex flex-col h-full">
            ...
            <div class="border-b border-purple-200 p-3 bg-gradient-to-r from-purple-50 to-orange-50/30">
              <div class="flex items-center justify-between gap-2">
                ...
                <button @click="openCreateModal" class="p-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 transition-colors" title="Nouveau Tenant">
                  <Plus class="h-5 w-5" />
                </button>
              </div>
            </div>
            ...
            <div class="overflow-y-auto flex-1">
              <div v-if="filteredTenants.length === 0" class="p-4 text-center text-gray-500">
                Aucun tenant trouvé.
              </div>
              <div v-else>
          ...
          <div v-else class="space-y-4">
            ...
            <div class="bg-white rounded-lg border border-purple-200 shadow-sm p-6">
              ...
              <div class="flex justify-between items-start mb-6">
                ...
                <div class="flex gap-2">
                  ...
                  <button @click="deleteTenant(selectedTenant.id)" class="p-2 text-red-600 hover:bg-red-50 rounded-lg transition-colors" title="Supprimer">
            ...
            <div class="bg-white rounded-lg border border-purple-200 shadow-sm overflow-hidden">
              ...
              <div class="p-4">
                ...
                <div v-if="(selectedTenant.domains || []).length === 0" class="text-center py-8 text-gray-400">
                  ...
                  >
                    <div class="flex items-center gap-4">
                      ...
                      <div>
                        ...
                        <a :href="'http://' + domain.domain + ':8000'" target="_blank" class="text-xs text-blue-500 hover:underline">
                          Ouvrir →
                        </a>
                      </div>
                    </div>
    ...
    <DialogModal :show="showModal" @close="closeModal">
      ...
      <template #content>
        <div class="space-y-4">
          <!-- ID (only for create) -->
          <div v-if="!isEditing">
            <InputLabel for="id" value="Identifiant (slug)" />
            <TextInput 
              v-model="form.id" 
              id="id" 
              type="text" 
            ...
            <InputError :message="errors.id" class="mt-1" />
          </div>

          <div>
            <InputLabel for="name" value="Nom de la compagnie" />
            <TextInput v-model="form.name" id="name" type="text" class="w-full mt-1" placeholder="Alpha Transport" />
          ...
          <div class="grid grid-cols-2 gap-4">
            <div>
              ...
              <TextInput v-model="form.email" id="email" type="email" class="w-full mt-1" placeholder="contact@company.com" />
              <InputError :message="errors.email" class="mt-1" />
            </div>
            <div>
              <InputLabel for="phone" value="Téléphone" />
              <TextInput v-model="form.phone" id="phone" type="tel" class="w-full mt-1" placeholder="+225 00 00 00 00" />
          ...
          <div v-if="!isEditing">
            <InputLabel for="domain" value="Domaine principal" />
            <TextInput v-model="form.domain" id="domain" type="text" class="w-full mt-1" placeholder="alpha.transport.ci ou alpha-express.com" />
            <p class="text-xs text-gray-500 mt-1">Sous-domaine (alpha.transport.ci) ou domaine personnalisé</p>
            <InputError :message="errors.domain" class="mt-1" />
          </div>
        </div>
      </template>
      <template #footer>
        <SecondaryButton @click="closeModal">Annuler</SecondaryButton>
        <PrimaryButton @click="submit" :disabled="processing" class="ml-3">
    ...
    <!-- Add Domain Modal -->
    <DialogModal :show="showDomainModal" @close="closeDomainModal">
      <template #title>
        Ajouter un Domaine
      </template>
      <template #content>
        <div>
          <InputLabel for="new-domain" value="Domaine" />
          <TextInput v-model="domainForm.domain" id="new-domain" type="text" class="w-full mt-1" placeholder="beta.transport.ci" />
