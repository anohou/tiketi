...
class InitialSetupSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $abidjan = Station::create([
            'name' => 'Abidjan - Gare d\'Adjamé',
            'code' => 'ABJ',
            'city' => 'Abidjan',
            'address' => 'Gare Routière d\'Adjamé, Abidjan',
            'latitude' => 5.3600,
            'longitude' => -4.0083,
            'active' => true
        ]);
        ...
        $bouake = Station::create([
            ...
            'code' => 'BKE',
            'city' => 'Bouaké',
            'address' => 'Gare Routière de Bouaké',
            'latitude' => 7.6944,
            'longitude' => -5.0300,
            'active' => true
        ]);
        ...
        $katiola = Station::create([
            ...
            'code' => 'KAT',
            'city' => 'Katiola',
            'address' => 'Gare Routière de Katiola',
            'latitude' => 8.1372,
            'longitude' => -5.0978,
            'active' => true
        ]);
        ...
        $korhogo = Station::create([
            ...
            'code' => 'KOR',
            'city' => 'Korhogo',
            'address' => 'Gare Routière de Korhogo',
            'latitude' => 9.4580,
            'longitude' => -5.6294,
            'active' => true
        ]);
        ...
        $adzope = Station::create([
            ...
            'code' => 'ADZ',
            'city' => 'Adzopé',
            'address' => 'Gare Routière d\'Adzopé',
            'latitude' => 6.1069,
            'longitude' => -3.8589,
            'active' => true
        ]);
        ...
        $abengourou = Station::create([
            ...
            'code' => 'ABG',
            'city' => 'Abengourou',
            'address' => 'Gare Routière d\'Abengourou',
            'latitude' => 7.1333,
            'longitude' => -3.2000,
            'active' => true
        ]);
        ...
        $agnibilekrou = Station::create([
            ...
            'code' => 'AGL',
            'city' => 'Agnibilékrou',
            'address' => 'Gare Routière d\'Agnibilékrou',
            'latitude' => 7.1333,
            'longitude' => -3.2000,
            'active' => true
        ]);
        ...
        $bondoukou = Station::create([
            ...
            'code' => 'BDK',
            'city' => 'Bondoukou',
            'address' => 'Gare Routière de Bondoukou',
            'latitude' => 8.0403,
            'longitude' => -2.8000,
            'active' => true
        ]);
